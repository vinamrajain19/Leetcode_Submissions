...
public:
    ...
    // count_oc counts the number of times sub occurs as a substring of s.

 // As for the recursive function rec , it tells us whether or not sub occurs at least k times in s. If it      does, then we can try making sub longer by appending a to z and seeing if it works.
